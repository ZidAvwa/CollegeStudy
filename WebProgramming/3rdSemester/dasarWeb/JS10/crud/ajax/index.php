...
<head>
    ...
    <link rel="stylesheet" href="httpsCSS/bootstrap.min.css"
...
<body>
    ...
    <script type="text/javascript">
        ...
        $("#simpan").click(function () {
            ...
            if (nama != "" && alamat != "" && (document.getElementById("jenkel1").checked == true || document.
                getElementById("jenkel2").checked == true) && no_telp != "") {
                $.ajax({
                    type: 'POST',
                    url: "form_action.php",
                    data: data,
