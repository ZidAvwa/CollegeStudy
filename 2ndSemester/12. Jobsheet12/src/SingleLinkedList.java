public class SingleLinkedList {
    ...
    void insertAfter(Student27 std, String key) {
        Node newNode = new Node(std, null);
        Node temp = head;
        do {
    ...
    public void insertAt(int index, Student27 std) {
        if (index < 0) {
