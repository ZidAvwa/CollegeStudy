...
public class StudentQueueMain27 {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        StudentQueue27 queue = new StudentQueue27(5);
        int choice;
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    Student27 std = new Student27(nim, name, studyProgram, className);
                    queue.enqueue(std);
                    break;
                case 2:
                    Student27 studentBeingServed = queue.dequeue();
