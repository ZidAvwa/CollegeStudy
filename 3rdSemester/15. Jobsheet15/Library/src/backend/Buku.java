...
public class Buku {
    ...
    private int idbuku;
    private Kategori kategori = new Kategori(); // Relation to Kategori Class
    ...
    public Buku getById(int id) {
        Buku buku = new Buku();
        // Uses Join to fetch category data along with the book
    ...
    public ArrayList<Buku> getAll() {
        ...
        // Uses Join to fetch all books with their category info
        ResultSet rs = DBHelper.selectQuery("SELECT "
                + "     b.idbuku AS idbuku, "
                + "     b.judul AS judul, "
                + "     b.penerbit AS penerbit, "
